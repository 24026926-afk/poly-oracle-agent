...
name: risk-auditor
type: always
globs: src/agents/evaluation/**,src/agents/execution/bankroll_tracker.py,src/schemas/llm.py
---
...
8. Pydantic dicts used for risk/sizing must include explicit
   @field_validators that recursively coerce floats to Decimals to
   prevent silent precision loss on JSON re-serialization.

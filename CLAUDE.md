...
Current WI set: WI-28 complete; dry-run boot-to-evaluation pipeline stabilized (NonceManager, Gamma parsing, WS subscription/list-handling, yes_token_id propagation, midpoint computation all fixed); 577 tests, 95% coverage

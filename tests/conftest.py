...
def test_config() -> AppConfig:
    ...
    return AppConfig.model_construct(
        ...
        # WI-52: LLM cost guard fields — disabled for existing tests
        enable_llm_cost_guard=False,
        llm_hourly_call_limit=1000,
        llm_reflection_hourly_call_limit=1000,
        llm_daily_call_limit=10000,
        llm_daily_token_limit=10000000,
        llm_daily_cost_limit_usd=Decimal("10000"),
        llm_market_hourly_call_limit=1000,
        llm_repeated_hold_threshold=5,
        llm_repeated_invalid_threshold=3,
        llm_market_cooldown_seconds=Decimal("300"),
        llm_fallback_tokens_per_call=4096,
        llm_cost_per_input_token_usd=Decimal("0.0000015"),
        llm_cost_per_output_token_usd=Decimal("0.000006"),
        enable_exposure_validator=False,
        enable_wallet_balance_check=False,
        gas_check_enabled=False,

...
async def consumer_mock(queue: asyncio.Queue):
    while True:
        ...
        logger.info("new_tick_received", event=msg.event, best_bid=best_bid, total_asks=total_asks)
        queue.task_done()

async def main():
    # Use condition_id as expected by ws_client.py
    TEST_CONDITION_ID = "0x2173a110cb1ba3c7b39912066c07dd82a4664b5953dd4305bc8c3e03cd530e8c" 
